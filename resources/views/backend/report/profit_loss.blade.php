			...
			<div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)$purchase[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
			...
			<div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)$sale[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
			...
			<div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)$return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
			...
			<div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)$purchase_return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
